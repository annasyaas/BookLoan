<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu mt-3">
            <li class="active"><a class="nav-link" href="{{ route('dashboard') }}"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
            <li class="active"><a class="nav-link" href="{{ route('book.index') }}"><i class="fa fa-book"></i> <span>Buku</span></a></li>
