<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand mt-2">
            <a href="/">PEMINJAMAN BUKU UNMUL</a>
        </div>
        <ul class="sidebar-menu mt-3">
            <li class="{{ Request::is('/') ? 'active' : '' }}"><a class="nav-link" href="{{ route('dashboard') }}"><i class="fa fa-home"></i> <span>Halaman Awal</span></a></li>
            <li class="{{ Request::is('book*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('book.index') }}"><i class="fa fa-book"></i> <span>Buku</span></a></li>
            <li class="{{ Request::is('member*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('member.index') }}"><i class="fa fa-users"></i> <span>Anggota</span></a></li>
