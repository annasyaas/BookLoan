...
Route::get('/getMember', [MemberController::class, 'getMember'])->middleware('auth')->name('getmember');
Route::delete('/memberDelete', [MemberController::class, 'deleteData'])->middleware('auth')->name('memberDelete');
